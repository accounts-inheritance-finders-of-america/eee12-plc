	...
	var view = Backbone.View.extend({
		...
		render : function() {
		    ...
		    $(".submitbtn").click(function() {
		    	...
		    	pidObject.Input = PLCSpace.PLCEditorSpace.pidId.split("&")[1];
			...
			$(document).live("keydown",function(e){
			 ...
			 jQuery(document).bind('keydown', 'Shift+p',function (evt){
									self.updateLadder("openContact");
						  });
						  jQuery(document).bind('keydown', 'Shift+c',function (evt){
									self.updateLadder("closeContact");
						  });
						  jQuery(document).bind('keydown', 'Shift+o',function (evt){
									self.updateLadder("addOutput");
						  });
						   jQuery(document).bind('keydown', 'Shift+l',function (evt){
									self.updateLadder("addLatch");
						  });
						  jQuery(document).bind('keydown', 'Shift+u',function (evt){
									self.updateLadder("addUnlatch");
						  });*/
/*
			 
			 jQuery(document).bind('keydown', 'ctrl+y',function (evt){
				 self.redo();
			 });
			 jQuery(document).bind('keydown', 'ctrl+z',function (evt){
				 self.undo();
			 });
			 jQuery(document).bind('keydown','del',function (e){
 ...
 jQuery(document).bind('keydown','del',function (e){
		...
		openFile : function(){			
			rung_cnt = PLCSpace.utilView.openFile();
			if(rung_cnt > 0){this._rungid = rung_cnt}
		},
		createRung : function(){
